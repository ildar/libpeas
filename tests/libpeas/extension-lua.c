...
#define EXTENSION_TEST_FUNC(loader, path, func) \
  ...
  EXTENSION_TEST (lua5.3, "instance-refcount", instance_refcount);
  EXTENSION_TEST (lua5.3, "activatable-subject-refcount",
                  activatable_subject_refcount);
  EXTENSION_TEST (lua5.3, "nonexistent", nonexistent);
